...
import getItems from '@salesforce/apex/ProductController.getItems';
import { deleteRecord } from 'lightning/uiRecordApi';
import couponInfo from '@salesforce/apex/ProductController.couponInfo';
import empty_cart from '@salesforce/resourceUrl/emptyccrt';
import addressDetails from '@salesforce/apex/ProductController.addressDetails';
import saveAddress from '@salesforce/apex/ProductController.saveAddress';
...
export default class CartDetail extends NavigationMixin(LightningElement) 
{
    ...
    connectedCallback(){
        ...
        console.log('Cart Image Url'+this.emptyccrt)
